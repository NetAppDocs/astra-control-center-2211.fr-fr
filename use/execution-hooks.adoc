...
Consultez le https://github.com/NetApp/Verda["Projet GitHub NetApp Verda"] pour voir des exemples et obtenir une idée de la façon de structurer vos crochets d'exécution. Vous pouvez utiliser ces exemples comme modèles ou scripts de test.
